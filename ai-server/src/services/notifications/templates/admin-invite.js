...
module.exports = {
    ...
    subject: 'Welcome to the Amzur Time Tracker - Admin Access Granted',
...
Welcome to the Amzur Time Tracker! 🎉
...
Best regards,
The Amzur Time Tracker Team

---
You're receiving this because you were added as an admin user to the Amzur Time Tracker.
    `.trim(),
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;">
                    ...
                    <tr>
                        <td align="center" style="background:linear-gradient(135deg,#1a73e8 0%,#0d47a1 100%);border-radius:10px 10px 0 0;padding:40px 40px 35px;">
                            ...
                            <h1 style="margin:0;color:#ffffff;font-size:26px;font-weight:700;letter-spacing:-0.5px;">Welcome to the Amzur Time Tracker</h1>
                    ...
                    <tr>
                        <td style="background:#ffffff;padding:36px 40px;">
                            ...
                            <p style="margin:0 0 28px;font-size:15px;color:#555;">
                                ${invitedBy ? `<strong>${invitedBy}</strong> has granted you admin access to the Amzur Time Tracker.` : 'You have been granted admin access to the Amzur Time Tracker.'}
                            </p>
                    ...
                    <tr>
                        <td align="center" style="background:#f0f4f8;border-radius:0 0 10px 10px;padding:20px 40px;border-top:1px solid #e0e0e0;">
                            ...
                            <p style="margin:0;font-size:12px;color:#aaa;">You&rsquo;re receiving this because you were added as an admin user to the Amzur Time Tracker.</p>
                        </td>
                    </tr>
