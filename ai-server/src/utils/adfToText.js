 ...
 *
 * This is a direct port of forge-app/src/utils/adfToText.js to CommonJS syntax.
 * Fixes Bug #1: Non-recursive ADF extraction in forge-proxy-controller.js
 *
 * @param {Object|string|null} description - ADF document or plain string
 ...
 * 
 * @param {Object} node - ADF node to traverse
 * @param {string[]} parts - Accumulator array for text fragments
 */
